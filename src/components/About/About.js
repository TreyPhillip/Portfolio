    ...
    render() {
        return (
            <main>
                ...
                <p className="block">
                    I live in Ontario, Canada and I recently graduated from Conestoga College with 
                    an Ontario College Advanced Diploma in Computer Science & IT. Since my graduation 
                    I have spent my time learning new technologies and enjoying my hobbies.
                </p>
                <header className="head">
                    <h2>Education</h2>
                </header>
                ...
                <p className="block">
                    My strongest skills are in C# and JavaScript. I have personal experience but no professional
                    experience in 
